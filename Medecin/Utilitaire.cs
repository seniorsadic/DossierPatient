...
namespace Medecin
{
    public static class Utilitaire
    {
        ...
        {
            return (Tools.executeSimpleQuery("SELECT COUNT(" + champ + ") FROM " + table + " WHERE " + champ + "='" + cle + "'") != "0");
        }

        public static bool existeNumDansTable(string champ1, string champ2, string table, string cle1, string cle2)
        {
            return (Tools.executeSimpleQuery("SELECT COUNT(" + champ1 + ") FROM " + table + " WHERE " + champ1 + "='" + cle1 + "' AND " + champ2 + "='" + cle2 + "'") != "0");
        }
