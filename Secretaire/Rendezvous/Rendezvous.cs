...
namespace Secretaire.Rendezvous
{
    public partial class Rendezvous : Form
    {
        ...
        public void charger()
        {
            ...
            model.Bind("select * from rendezvous where idPersonnel='" + idMedecin+"' and dateRv between '" + dateDebut.ToString("yyyy-MM-dd") + " 00:00:00' and '" + dateFin.ToString("yyyy-MM-dd") + " 00:00:00' order by dateRv", test.rendezvous);
        ...
        public void enregistrer(string idPatient, DateTime date)
        {
            ...
            {
                Tools.executeLMD_Query("Update rendezvous set idPatient='" + idPatient + "' WHERE idRv='" + k + "'");
            }
            else
            {
                Tools.executeLMD_Query("INSERT INTO rendezvous(idPersonnel,idPatient,dateRv) VALUES ('" +
                      idMedecin + "','" +
                      idPatient + "','" +
