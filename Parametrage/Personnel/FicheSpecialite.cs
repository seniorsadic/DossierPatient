...
{
    public partial class FicheSpecialite : Form
    {
        Model mdl = new Model();
        public FicheSpecialite()
        {
            InitializeComponent();
        }

        private void FicheSpecialite_Load(object sender, EventArgs e)
        {
            mdl.Bind(dataGridView1, bindingNavigator1, paramDataSet.specialite, specialiteBindingSource, "select * from specialite");
        ...
        private void supprimerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                {
                    ConnexionDPI.Tools.executeLMD_Query("Delete from specialite  WHERE idSpecialite='" + dataGridView1.CurrentRow.Cells[0].Value + "'");
                    this.Refresh();
                }
            }
        }
