...
{
    public partial class FicheService : Form
    {
        Model mdl = new Model();
        public FicheService()
        {
        ...
        private void FicheService_Load(object sender, EventArgs e)
        {
            
            mdl.Bind(dataGridView1, bindingNavigator1, paramDataSet.service, serviceBindingSource, "select * from service");
